...
public class SimilaritaCoseno implements Comparable<SimilaritaCoseno>{
    ...
    private ArrayList<Double> vettoreA, vettoreB;
    ...
    // Costruttore per due vettori generici
    public SimilaritaCoseno(ArrayList<Double> vettoreA, ArrayList<Double> vettoreB){

        this.vettoreA = vettoreA;
        this.vettoreB = vettoreB;

        if (controlloDimensione()){

            this.scoreSimilarita = calcolaScoreVettore();
    ...
    public double calcolaScoreVettore(){

        double similarita = 0;

        double numeratore = 0, denA = 0, denB = 0, denominatore = 0;

        for (int i=0; i<vettoreA.size(); i++){

            numeratore += vettoreA.get(i)*vettoreB.get(i);

            denA = Math.pow(vettoreA.get(i), 2);
            denB = Math.pow(vettoreB.get(i), 2);
    ...
    public boolean controlloDimensione(){

        if (vettoreA.size() != vettoreB.size()){
